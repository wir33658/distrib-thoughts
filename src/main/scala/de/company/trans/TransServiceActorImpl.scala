...
import de.company.blobstore.BlobStoreServiceClientActorImpl
import de.company.bus.{Events, EventSubjects}
...
object TransServiceActorApp extends App {
  ...
  val system = ActorSystem("actorsystemname", config.getConfig("transservice"))
